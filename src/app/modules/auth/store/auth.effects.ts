...
import { AuthError, AuthState, LoginFormData, TokenData } from '../models/login.model'
import { AuthApiService } from '../services/auth-api.service'
import { authFailure, authSuccess, loginAction, logoutAction, resetAuthState } from './auth.actions'
        ...
        this.actions$
            .pipe(
                ...
                exhaustMap(([_, userId]: [Action, string | undefined]) => {
                    ...
                    return this.userApiService.updateOnlineStateRequest(userId, false)
                        .pipe(
                            map(() => resetAuthState()),
                            tap(() => {
